        ...
        categories: [
            {
                ...
                prompts: [
                    ...
                    "Floor plan with small and large meeting rooms",
                    "Hallway layout including executive office",
                ],
            },
            {
                category: "Design Research & Inspiration",
                prompts: [
                    "HVAC (heating, ventilation, air conditioning) drawing",
                    "Floor plan with conference room",
                    "Drawing with image wall",
                    "Spacious workspace layout",
                ],
            },
        ],
    },
